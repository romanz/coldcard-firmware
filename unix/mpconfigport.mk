...
CFLAGS_MOD += -I$(TOP)/../secp256k1-zkp -I$(TOP)/../secp256k1-zkp/src
CFLAGS_MOD += -Wno-unused-function
CFLAGS_MOD += -DSECP256K1_BUILD -DUSE_NUM_NONE -DUSE_FIELD_INV_BUILTIN -DUSE_SCALAR_INV_BUILTIN
CFLAGS_MOD += -DUSE_FIELD_10X26 -DUSE_SCALAR_8X32 -DUSE_ECMULT_STATIC_PRECOMPUTATION -DUSE_EXTERNAL_DEFAULT_CALLBACKS -DECMULT_WINDOW_SIZE=8
CFLAGS_MOD += -DENABLE_MODULE_GENERATOR -DENABLE_MODULE_RANGEPROOF -DENABLE_MODULE_RECOVERY -DENABLE_MODULE_ECDH
SRC_MOD += $(addprefix secp256k1-zkp/, src/secp256k1.c)
